...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ControllerInputActionManager : MonoBehaviour
    {
        ...
        /*[SerializeField]
        [Tooltip("The reference to the action to touch the trigger button.")]
        InputActionReference m_Trigger;*/
        ...
        {
           /* var triggerAction = GetInputAction(m_Trigger);
            if (triggerAction != null)
            {
                triggerAction.started += OnStartLocomotion;
                triggerAction.canceled += OnStopLocomotion;
